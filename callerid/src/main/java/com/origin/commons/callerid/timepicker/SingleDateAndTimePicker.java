...
import com.origin.commons.callerid.timepicker.widget.WheelDayPicker;
import com.origin.commons.callerid.timepicker.widget.WheelHourPicker;
import com.origin.commons.callerid.timepicker.widget.WheelMinutePicker;
...
public class SingleDateAndTimePicker extends LinearLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        hoursPicker.setOnFinishedLoopListener(picker -> daysPicker.scrollTo(daysPicker.getCurrentItemPosition() + 1)).setHourChangedListener((picker, hour) -> {
            updateListener();
            checkMinMaxDate(picker);
        });
