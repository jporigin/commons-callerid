...
public abstract class WheelPicker<V> extends View {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mItemTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_item_text_size, getResources().getDimensionPixelSize(R.dimen.WheelItemTextSize)); // 24sp
        ...
        mIndicatorSize = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_indicator_size, getResources().getDimensionPixelSize(R.dimen.WheelIndicatorSize)); // 2dp
